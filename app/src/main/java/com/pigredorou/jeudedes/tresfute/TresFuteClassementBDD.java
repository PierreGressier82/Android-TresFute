...
class TresFuteClassementBDD {

    private SQLiteDatabase bdd;
    private SQLiteOpenHelper maBaseSQLite;

    TresFuteClassementBDD(Context context){
    ...
    void insertClassement(TresFuteClassement classement){
        ...
        bdd.insert(TresFuteDBOpenHelper.Constants.TABLE_CLASSEMENT, null, values);
    }
...
//
    ...
    Cursor getClassementTrieParSCore(int nbScore){
        //Récupère dans un Cursor les valeurs correspondant à un livre contenu dans la BDD (ici on sélectionne le livre grâce à son titre)
        return bdd.query(TresFuteDBOpenHelper.Constants.TABLE_CLASSEMENT, new String[] {TresFuteDBOpenHelper.Constants.COL_ID,
                ...
                TresFuteDBOpenHelper.Constants.COL_NBJ}, null, null, null, null, TresFuteDBOpenHelper.Constants.COL_SCORE + " DESC", String.valueOf(nbScore));
    }
